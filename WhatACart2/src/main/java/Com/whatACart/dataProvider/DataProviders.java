package Com.whatACart.dataProvider;
...
import Com.jbk.utilities.NewExcelLibrary;
...
public class DataProviders {
	...
	//Class --> LoginPageTest,HomePageTest Test Case--> loginTest, wishListTest, orderHistoryandDetailsTest
		...
		public Object[][] getCredentials() {
			// Totals rows count and Credentials is WorksheetName
			int rows = obj.getRowCount("Credentials");
			// Total Columns and Credentials is WorksheetName
